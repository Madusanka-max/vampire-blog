...
<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="space-y-4 mt-4">
            ...
            class="w-full flex items-center justify-center gap-2 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700">
            ...
            class="w-full flex items-center justify-center gap-2 bg-gray-800 text-white px-4 py-2 rounded hover:bg-gray-900">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
